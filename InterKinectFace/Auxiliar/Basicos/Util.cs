...
namespace Auxiliar.Basicos
{
    public static class Util
    {
        
        //Realiza a comparação com margem de erro para não forçar o movimento exato(pois cada um tem um tamanha e porte fisico)
        ...
        //############# Funções não utilizadas nesta versão porem de utilidade futura para calculos entre as juntas ###################################
